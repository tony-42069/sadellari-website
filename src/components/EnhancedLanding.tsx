    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative z-10 w-full overflow-x-hidden">
      ...
      >
        <div className="space-y-6 w-full">
          ...
          >
            <div className="flex flex-row flex-wrap items-center justify-center styled-letters bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-blue-400 drop-shadow-[0_0_15px_rgba(147,51,234,0.5)] filter hover:brightness-110 transition-all w-full px-4">
              <div className="flex flex-row flex-wrap justify-center gap-2 max-w-full overflow-hidden">
                <Image 
                  src="/s-logo-transparent.png"
                  alt="S Logo"
                  width={160}
                  height={160}
                  className="h-[2em] sm:h-[1.4em] w-auto object-contain"
                  priority
                />
                <Image 
                  src="/a-logo-1.png"
