    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative z-10 w-full overflow-x-hidden">
      ...
      >
        <div className="space-y-6 w-full">
          ...
          >
            <div className="flex flex-row items-center justify-center styled-letters bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-blue-400 drop-shadow-[0_0_15px_rgba(147,51,234,0.5)] filter hover:brightness-110 transition-all max-w-full overflow-x-hidden px-4 gap-[0.25rem] sm:gap-[0.5rem] tracking-tight sm:text-[3rem]">
              {['s-logo-transparent', 'a-logo-1', 'd-logo', 'e-logo', 'l-logo-1', 'l-logo-2', 'a-logo-2', 'r-logo', 'i-logo'].map((logo, index) => (
                <div key={index} className="flex justify-center items-center w-[12vw] sm:w-[8vw] md:w-[6vw] h-auto">
                  <Image 
                    src={`/${logo}.png`}
